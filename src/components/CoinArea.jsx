...
<div className='space-y-3 relative z-10'>
  {filteredCryptos.slice(0, 12).map((item) => (
    <Link to={`/crypto/${item.id}`} key={item.id} className="block p-4 bg-gray-800/30 backdrop-blur-md hover:bg-gray-700/40 rounded-xl border border-emerald-500/10 hover:border-emerald-500/30 transition-all duration-300 group">
...
<div className="hidden md:grid grid-cols-5 gap-4 items-center">
  ...
  <div className='flex items-center gap-3'>
    <img src={item.image} alt={item.name} className='w-8 h-8 lg:h-10 rounded-full bg-gradient-to-r from-emerald-500/20 to-cyan-500/20 p-0.5'/>
